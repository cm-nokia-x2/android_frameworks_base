...
*/
    ...
    int RIL_REQUEST_SET_INITIAL_ATTACH_APN = 10111;
    int RIL_REQUEST_IMS_REGISTRATION_STATE = 112;
    int RIL_REQUEST_IMS_SEND_SMS = 113;
    int RIL_REQUEST_SIM_TRANSMIT_APDU_BASIC = 214;
    int RIL_REQUEST_SIM_OPEN_CHANNEL = 215;
    ...
    int RIL_REQUEST_SIM_GET_ATR = 1121;
    ...
    int RIL_UNSOL_SRVCC_STATE_NOTIFY = 1139;
    int RIL_UNSOL_HARDWARE_CONFIG_CHANGED = 1140;
    int RIL_UNSOL_DC_RT_INFO_CHANGED = 11041;
